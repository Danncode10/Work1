...
- Set `NODE_ENV=production` to disable API docs in production (returns 404 Not Found)
- Docker container must be rebuilt and restarted after changing NODE_ENV
...
### Current Status
- ✅ Ingredients API now requires authentication
- ✅ API documentation disabled in production
- ✅ Frontend configured to send auth headers
- 🔄 Ready for n8n integration testing
